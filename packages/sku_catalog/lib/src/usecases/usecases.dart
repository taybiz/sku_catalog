/// The application half: the operations a catalog of SKUs, devices, places and
/// assemblies needs, expressed against the domain's repository contracts.
///
/// Nothing here reaches for a concrete store — pass any implementation of the
/// `I*Repository` contracts from `sku_catalog_domain.dart`.
library;
